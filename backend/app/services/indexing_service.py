...
abstractions and a scanner callable — never on GitPython or SQLAlchemy
directly, so it can be unit tested with fakes and swapped onto different
infrastructure later without changes here.
"""
...
from app.domain.models import FileMetadata, RepositoryInfo, TreeNode
